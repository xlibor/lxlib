...
View.composer({'administrator::layouts.default'}, function(view)
    ...
    view.css = view.css + {customscroll = asset('packages/summerblue/administrator/js/jquery/customscroll/customscroll.css'), main = asset('packages/summerblue/administrator/css/main.css'), ['main-extended'] = asset('packages/summerblue/administrator/css/main-extended.css')}
    ...
    if not view.page and not view.dashboard then
        ...
        view.myjs = view.myjs + {ckeditor = asset('packages/summerblue/administrator/js/ckeditor/ckeditor.js'), ['ckeditor-jquery'] = asset('packages/summerblue/administrator/js/ckeditor/adapters/jquery.js'), plupload = asset('packages/summerblue/administrator/js/plupload/js/plupload.full.js')}
    ...
    view.js = view.js + {page = asset('packages/summerblue/administrator/js/page.js')}
end)